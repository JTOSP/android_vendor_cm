...
ALARM_PATH := vendor/jtosp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/jtosp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/jtosp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/jtosp/prebuilt/common/media/audio/ui
